...
{        
    if (e.target !== e.currentTarget) 
    {
        ...
        if(T.className=="SPMN SPMNI" || T.className=="SPMN SPMNA")
        {
            ...
            {
                triggerthink(1);
                GOTOPAGE('','gradenewjob.htm','_self');
            }
            else
            {
                SEARCHNOW();   
        ...
        {
            triggerthink(1);
            GOTOPAGE(AR[1],'viewscore.htm','_self');
        }
    }
}
...
function SEARCHNOW()
{
    ...
    xmlhttp.onreadystatechange=function()
    {
        ...
        {                                                                                               
            ...
            {
                ALLERR("No Grading Sessions found. Click GRADE NEW JOB to start");
                document.getElementById("CNTHERE").innerHTML = '';            
            }
            else
            {
    ...
    xmlhttp.open("POST",siteaddress+"/system/B_FILE1/",true);
